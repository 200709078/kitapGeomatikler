const sorularSirali_T = [
    {
        yonerge: 'Aşağıda verilen kavramları doğru bilim insanıyla eşleştiriniz.',
        sorular: [
            { text: 'Fluxion &#8658; *** <span style="color: #ff0008ff;">Newton</style>' },
            { text: '\\( \\frac{dy}{dx} \\) &#8658; *** <span style="color: #ff0008ff;">Leibniz</style>' },
            { text: 'Nokta notasyonu (\\( \\dot{x} \\)) &#8658; *** <span style="color: #ff0008ff;">Newton</style>' },
            { text: 'Nova Methodus &#8658; *** <span style="color: #ff0008ff;">Leibniz</style>' }
        ],
        tipi: "bd",
        puan: 25,
        dogrular: ['Newton', 'Leibniz', 'Newton', 'Leibniz'],
        secimler: ['Newton', 'Leibniz'],
        aciklama: [
            ["NEWTON'UN TÜREV YAKLAŞIMI", 'Isaac Newton (1643–1727) değişen nicelikleri “fluents” (akıntılar), bunların anlık değişim hızlarını ise "fluxions" (akıntıların hızı) diye adlandırdı.'],
            ["LEIBNIZ'İN TÜREV YAKLAŞIMI", 'Bugün hâlâ kullandığımız türev gösterimi \\( \\frac{dy}{dx} \\), Leibniz tarafından ortaya konmuştur.'],
            ["NEWTON'UN TÜREV YAKLAŞIMI", 'Newton’un türevi (\\( \\dot{x} \\)) üstüne nokta koyarak ifade etmiştir.'],
            ["LEIBNIZ'İN TÜREV YAKLAŞIMI", 'Açıklama eklenecek...']
        ]
    },
    {
        soru: '"Newton türevi daha çok fiziksel problemlerde kullanmıştır." ifadesine göre seçim yapınız.',
        tipi: "dy",
        puan: 25,
        secenekler: [
        ...
        aciklama: ["NEWTON'UN TÜREV YAKLAŞIMI", '"Yani Newton’a göre türev, bir niceliğin anlık değişim hızı idi. Fiziksel yorumlara ağırlık verdi: özellikle hız, ivme, hareket gibi kavramları açıklamak için türev kullandı."'],
    },
    {
        soru: '"Leibniz, türevi küçük farkların oranı şeklinde tanımlamıştır." ifadesine göre seçim yapınız.',
        tipi: "dy",
        puan: 25,
        secenekler: [
            { text: 'Doğrudur. <span style="color: #ff0008ff;">*</style>', correct: true },
        ...
        aciklama: ["LEIBNIZ'İN TÜREV YAKLAŞIMI", '"Gottfried Wilhelm Leibniz (1646–1716) türevi, küçük farkların oranı şeklinde düşündü."'],
    },
    {
        soru: '"Newton türev için bugün kullandığımız \\( \\frac{dy}{dx} \\) notasyonunu geliştirmiştir." ifadesine göre seçim yapınız.',
        tipi: "dy",
        puan: 25,
        secenekler: [
        ...
        aciklama: ["LEIBNIZ'İN TÜREV YAKLAŞIMI", 'Bugün hâlâ kullandığımız türev gösterimi \\( \\frac{dy}{dx} \\), Leibniz tarafından ortaya konmuştur.'],
    }
]
