const sorularSirali_T = [
        {
        soru: 'T₀ cismin durgun hâlde ölçülen zamanı, v cismin hızı , c ışık hızı olmak üzere özel görelilik kuramına göre hareket eden bir cismin zamanı \\( T = \\frac{T_0}{\\sqrt{1 - \\frac{v^2}{c^2}}} \\) şeklinde modellenmektedir.Buna göre v → c⁻ iken T aşağıdakilerden hangisi olur?',
        tipi: 'cs',
        puan: 25,
        secenekler: [
        ...
        aciklama: ["HAREKETLİ CİSİM", 'v → c⁻ iken 1 − v²/c² → 0⁺']
    },
    {
        soru: 'Bir firmanın üretim maliyetindeki ani değişimi \\( f(x) = \\frac{x^2 + a x - 10}{x - 2} \\) fonksiyonuyla modellenmiştir. \\( \\lim_{x \\to 2} f(x) = b ∈ \\mathbb{R} \\) gerçek  sayısına yaklaştığına göre a değeri aşağıdakilerden hangisidir?',
        tipi: 'cs',
        puan: 25,
        secenekler: [
            ...
            { text: '3 <span style="color: #ff0008ff;">*</style>', correct: true }
        ],
        aciklama: ["ÜRETİM MALİYETİ", 'x=2 için payın da sıfır olması gerekir. Buradan <br> 4 + 2a − 10 = 0 <br> a = 3 olur.']
    },
    {
        soru: 'Bir aracın fren mesafesi hızla ilişkilendirilmiş ve başkatsayısı 1 olan ikinci dereceden bir P(x) polinomuyla modellenmiştir.<br> \\( \\lim_{x \\to 1} \\frac{P(x)}{x-1} = 4 \\) olduğuna göre P(x−1) polinomunun sabit terimi aşağıdakilerden hangisidir?',
        tipi: 'cs',
        puan: 25,
        secenekler: [
            { text: '-3 <span style="color: #ff0008ff;">*</style>', correct: true },
        ...
        aciklama: ["FREN MESAFESİ", 'P(x)=x²+2x-3 olur. x = 0 için p(-1) hesaplanırsa sabit terim -3 olarak bulunur.']
    },
    {
        soru: 'Bir mühendis, kare biçimindeki bir alanın kenar uzunluğunu yaklaşık olarak bulmak için aşağıdaki yinelemeyi kullanıyor.<br>\\( x_{1} = 64 \\)<br>\\( x_{n+1} = \\frac{x_n}{2} + \\frac{18}{x_n} \\)<br>Buna göre bu dizinin limiti aşağıdakilerden hangisidir?',
        tipi: 'cs',
        puan: 25,
        secenekler: [
        ...
        aciklama: ["DİZİLERİN LİMİTİ", 'Limit L ise <br> \\( L = \\frac{L}{2} + \\frac{18}{L} \\) <br> \\( 2L = L + \\frac{36}{L} \\) <br> \\( L^2 = 36 \\) <br> \\( L = 6 \\) olur.']
    },
]
